...
![Duplicate button for Figma template](../images/01-duplicate.jpg)
...
![Social post preview images](../images/01-social-previews.png)
...
![Large Image Preview](../images/01-console.png)
...
![Open graph images on Figma](../images/01-gradient.png)
...
![Open graph image Gradient](../images/01-open-graph-img.png)
...
![Social post preview images](../images/01-rec-background.png)
...
![Social post preview images](../images/01-hsl.png)
...
![Border Radius Figma](../images/01-border-radius.png)
...
![Card with Title](../images/01-card-title.png)
...
![Card with Tags](../images/01-card-tags.png)
...
![Text Align Right](../images/01-text-align.png)
...
![Text on Twitter Card](../images/01-text-twitter.png)
...
![open graph image with title and text](../images/01-open-graph-text.png)
